...
{{-- GAMBAR BAWAH --}}
<div class="fixed bottom-0 left-0 w-full pointer-events-none z-0 flex justify-between items-end">

<img src="{{ asset('images/tools-kiri.png') }}" class="h-64 object-contain">

<img src="{{ asset('images/tools-kanan.png') }}" class="h-64 object-contain">
