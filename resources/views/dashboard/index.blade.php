...
@section('content')
    ...
    <div class="py-3 px-3 sm:px-4 md:px-6 lg:px-8 w-full min-w-0 max-w-full overflow-hidden">
        ...
        <div class="mb-4 sm:mb-6 md:mb-8">
            {{-- DIUBAH: Warna teks judul menjadi #5EA6FF --}}
            ...
            <div
                ...
                <div class="ml-2 sm:ml-3 md:ml-4 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12 opacity-80" fill="none"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            ...
            <div class="rounded-xl sm:rounded-2xl bg-white shadow-xl overflow-hidden flex flex-col">
                ...
                <div
                    class="flex-grow overflow-x-auto max-h-[280px] sm:max-h-[360px] md:max-h-[440px] lg:max-h-none overflow-y-auto">
                    @forelse($peminjamanTerbaru as $trx)
                        <div
                            ...
                            <div class="flex-shrink-0">
                                @if($trx->is_confirm)
                                    <span
                                        class="bg-yellow-100 text-yellow-700 text-[10px] sm:text-xs font-semibold px-2 sm:px-3 py-0.5 sm:py-1 rounded-full border border-yellow-200 whitespace-nowrap">
                                        Dipinjam
                                    </span>
                                @else
                                    <span
                                        class="bg-green-100 text-green-700 text-[10px] sm:text-xs font-semibold px-2 sm:px-3 py-0.5 sm:py-1 rounded-full border border-green-200 whitespace-nowrap">
                                        Selesai
                                    </span>
                                @endif
                            </div>
