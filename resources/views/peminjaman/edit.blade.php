            ...
            <form id="updateForm" action="{{ route('peminjaman.update', $transaction->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="borrower_name" name="borrower_name" value="{{ $transaction->borrower_name }}"
                    ...
                    <div>
                        ...
                        <input type="date" id="dateInput" name="date" value="{{ $transaction->date->format('Y-m-d') }}"
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-white shadow-md focus:ring-2 focus:ring-[#5EA6FF] focus:border-transparent transition duration-200 text-sm">
                    </div>
