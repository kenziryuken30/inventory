...
<div class="max-w-7xl mx-auto p-6"
     ...
     @close-modal.window="openTools = false">

<h2 class="text-xl font-semibold mb-6">Peminjaman Tools</h2>
...
<div class="bg-white shadow rounded-xl p-6">
    ...
    <div class="grid md:grid-cols-3 gap-6">
        <input type="text" name="client_name"
            class="border rounded-lg px-3 py-2" placeholder="Nama Client">

        <input type="text" name="project"
            class="border rounded-lg px-3 py-2" placeholder="Proyek">

        <input type="text" name="purpose"
            class="border rounded-lg px-3 py-2" placeholder="Keperluan">
    </div>
</div>
...
<div class="bg-white w-11/12 max-w-6xl rounded-2xl shadow-2xl">
                    ...
                    <td class="px-6 py-4">
                        <img src="{{ $serial->toolkit->image 
                            ...
                            : asset('images/no-image.png') }}"
                             class="w-14 preview-image cursor-pointer">
                    </td>
    ...
    {{-- FOOTER --}}
    <div class="flex justify-end gap-4 px-8 py-5 border-t bg-gray-50">
        <button @click="openTools = false"
...
<div id="imagePreviewModal"
    ...
    <div class="relative">
        <button id="closePreview"
                class="absolute -top-8 right-0 text-white text-2xl">✕</button>
        <img id="previewImage"
