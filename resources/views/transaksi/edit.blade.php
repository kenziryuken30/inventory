...
@section('content')
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="max-w-7xl mx-auto" x-data="{ openModal:false }"></div>
        <form action="{{ route('transaksi.update', $transaction->id) }}" method="POST">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6">
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="client" value="{{ $transaction->client }}"
                            class="w-full mt-1 px-4 py-2 rounded-lg border shadow-sm" placeholder="Masukan nama klien">
                    </div>

                    <div>
                        <label class="text-sm text-gray-600">Proyek</label>
                        <input type="text" name="project" value="{{ $transaction->project }}"
                            class="w-full mt-1 px-4 py-2 rounded-lg border shadow-sm" placeholder="Masukan Keterangan">
                    </div>

                    <div>
                        <label class="text-sm text-gray-600">Keperluan</label>
                        <input type="text" name="purpose" value="{{ $transaction->purpose }}"
                            class="w-full mt-1 px-4 py-2 rounded-lg border shadow-sm" placeholder="Masukan Keperluan">
                    </div>
                ...
                <div class="flex justify-end mt-6">
                    <button class="bg-[#268397] hover:bg-[#1d6d7c] text-white px-6 py-2 rounded-lg shadow">
                        Save
                    </button>
                </div>
    ...
    {{-- ================= MODAL TAILWIND ================= --}}
    <div x-show="openModal" x-transition class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">

        <div @click.outside="openModal = false" class="bg-white w-full max-w-3xl rounded-2xl shadow-2xl p-6">
            ...
            {{-- SEARCH --}}
            <div class="mb-4">
                <input type="text" placeholder="Cari Nama Consumable" class="w-full px-4 py-2 rounded-xl shadow
                           bg-[linear-gradient(180deg,#4CCAE6_0%,#268397_100%)]
                    ...
                    <tbody>
                        ...
                        @foreach ($consumables as $c)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="text-center">
                                    <img src="{{ $c->photo ?? asset('img/default.png') }}"
            ...
            <div class="flex justify-end gap-3 mt-5">
                ...
                <button @click="openModal=false" class="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 shadow">
                    Batal
                </button>
