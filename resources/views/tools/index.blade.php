...
<div class="max-w-7xl mx-auto w-full pt-4 sm:pt-6 pb-8 sm:pb-10">
    ...
    <div class="bg-gradient-to-b from-[#5FD0DF] to-[#22A8B8] p-3 sm:p-5 rounded-2xl shadow-md mb-4 sm:mb-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden min-h-[400px]">
        <div class="overflow-x-auto">
            ...
            <table class="w-full text-sm min-w-[700px]">
                ...
                <thead>
                    <tr class="bg-gradient-to-r from-[#5FD0DF] to-[#1CA7B6]">
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-center text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap w-[70px] sm:w-[80px]">Foto</th>
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-left text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap pl-4 sm:pl-6">Nama</th>
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-center text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap hidden md:table-cell">Kategori</th>
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-center text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap hidden md:table-cell">No Seri</th>
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-center text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap">Status</th>
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-center text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap hidden md:table-cell">Kondisi</th>
                        <th class="py-3 sm:py-4 px-3 sm:px-4 text-center text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider whitespace-nowrap w-[90px] sm:w-[110px]">Aksi</th>
                    </tr>
                </thead>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-cyan-50 transition h-[60px] sm:h-[70px]">
                        ...
                        {{-- NAMA --}}
                        <td class="py-2.5 sm:py-3 px-3 sm:px-6 font-semibold text-gray-800 text-xs sm:text-sm whitespace-nowrap align-middle">
                            {{ $tool->toolkit->toolkit_name }}
                        </td>

                        {{-- KATEGORI --}}
                        <td class="py-2.5 sm:py-3 px-2 sm:px-3 text-center align-middle hidden md:table-cell">
                            <span class="inline-block px-2.5 sm:px-3 py-1 text-[10px] sm:text-xs font-medium rounded-full bg-gray-100 text-gray-600">
                                {{ $tool->toolkit->category->category_name ?? '-' }}
                            </span>
                        </td>

                        {{-- NO SERI --}}
                        <td class="py-2.5 sm:py-3 px-2 sm:px-3 text-center font-medium text-gray-700 text-xs sm:text-sm whitespace-nowrap align-middle hidden md:table-cell">
                            {{ $tool->serial_number }}
                        </td>
                        ...
                        <td class="py-2.5 sm:py-3 px-2 sm:px-3 text-center align-middle hidden md:table-cell">
                            @if($condition == 'baik')
                            <span class="inline-block px-2.5 sm:px-3 py-1 text-[10px] sm:text-xs font-semibold rounded-full border border-green-400 text-green-700 bg-green-50 whitespace-nowrap">Baik</span>
                            @elseif($condition == 'rusak')
                            <span class="inline-block px-2.5 sm:px-3 py-1 text-[10px] sm:text-xs font-semibold rounded-full border border-red-400 text-red-700 bg-red-50 whitespace-nowrap">Rusak</span>
                            @else
                            <span class="inline-block px-2.5 sm:px-3 py-1 text-[10px] sm:text-xs font-semibold rounded-full border border-gray-400 text-gray-600 bg-gray-50 whitespace-nowrap">Maintenance</span>
                            @endif
                        </td>
                            ...
                            <div class="flex justify-center items-center gap-1.5 sm:gap-2.5">
                                ...
                                <form action="{{ route('tools.finishMaintenance', $tool->id) }}" method="POST">
                                    ...
                                    <button type="submit" title="Selesai Maintenance"
                                        ...
                                        <svg class="w-4 h-4 sm:w-[18px] sm:h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <button type="button"
                                    ...
                                    <svg class="w-4 h-4 sm:w-[18px] sm:h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 7h12M9 7V5a1 1 0 011-1h4a1 1 0 011 1v2m-7 0h8l-1 13a2 2 0 01-2 2H11a2 2 0 01-2-2L8 7z" />
                                    </svg>
                                </button>
                                @else
    ...
    <div id="tambahBarangModal"
        ...
        <div class="w-[calc(100%-1.5rem)] sm:w-11/12 max-w-xl bg-gradient-to-b from-[#f7f7f7] to-[#eee] rounded-2xl shadow-2xl max-h-[92vh] flex flex-col">

            <form action="{{ route('tools.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col min-h-0">
                @csrf

                @if ($errors->any())
                <div class="mx-4 sm:mx-6 mt-4 bg-red-100 text-red-700 p-3 rounded-lg text-sm">
                    <ul>
