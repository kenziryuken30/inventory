...
@section('content')
            ...
            <div class="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
                ...
                <form method="GET" action="{{ route('tools.index') }}"
                    ...
                    <div class="relative flex-1">
                        ...
                        <input id="searchInput" type="text" name="search" value="{{ request('search') }}" placeholder="Cari barang..."
                ...
                <table class="w-full text-sm min-w-[700px]">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @forelse ($tools as $tool)
                            ...
                            @php $condition = optional($tool->latestCondition)->condition ?? 'baik'; @endphp
                            ...
                            <tr class="hover:bg-cyan-50 transition h-[60px] sm:h-[70px] group">
                                ...
                                <td class="py-3 sm:py-3.5 px-2 sm:px-3 text-center align-middle">
                                    ...
                                    <img src="{{ $tool->toolkit && $tool->toolkit->image
                                ...
                                <td class="py-3 sm:py-3.5 px-2 sm:px-3 text-center align-middle">
                                    ...
                                    @if ($tool->status_label === 'pending')
                                        <span class="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-xs font-medium">
                                            Pending
                                        </span>

                                    @elseif ($tool->status_label === 'dipinjam')
                                        <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">
                                            Dipinjam
                                        </span>

                                    @elseif ($tool->status_label === 'tidak tersedia')
                                ...
                                <td class="py-3 sm:py-3.5 px-2 sm:px-3 text-center align-middle">
                                    <div class="flex justify-center items-center gap-2 sm:gap-3">
                                        ...
                                        @if ($tool->status_label == 'dipinjam' || $condition === 'rusak')
                                            <button type="button"
                ...
                <form id="editBarangForm" method="POST" enctype="multipart/form-data" class="flex flex-col min-h-0">
                    ...
                    <div class="flex justify-end gap-3 px-5 sm:px-8 py-4 border-t border-gray-200 flex-shrink-0">
                        ...
                        <button type="submit"
                            ...
                            <svg class="w-4 h-4 mr-2 transition-all duration-200" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.btn-disabled-delete').forEach(btn => {
                btn.addEventListener('click', function () {
                    showNotif('Barang sedang dipinjam / rusak, tidak bisa dihapus!', 'error');
                });
            });
